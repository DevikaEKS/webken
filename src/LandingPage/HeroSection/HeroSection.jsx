...
and spinal wellness care" className="w-full max-w-md h-auto object-contain" />
      ...
      <div className="w-full md:w-1/2 flex flex-col mt-10 items-center md:items-start text-center md:text-left">
        <div className="font-helvetica text-start">
          ...
          <p className="text-[#001040] font-bold text-xl sm:text-3xl md:text-2xl my-3">Buy Dr. Ken Hansraj’s Best-Selling Book:</p>
          <p className="font-bold text-[#E00000] text-xl sm:text-2xl md:text-3xl mt-6">Watch Your Back</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          <button className="w-full sm:w-auto px-6 py-3 flex items-center justify-center gap-2  firstbtn"  onClick={Bookspage}>
          ...
          <button className=" w-full sm:w-auto px-6 py-3 flex items-center justify-center gap-2 secondbtn" onClick={Coursepage}>
