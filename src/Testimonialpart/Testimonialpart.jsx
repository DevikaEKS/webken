import React, { useEffect, useState } from 'react';
 // Keep this if you're using custom styles
...
function Testimonialpart() {
  ...
  async function getTestimonial() {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/testimonial`);
        ...
        <div className="col-md-6 mb-4 order-2 order-md-1">
          <div className="crd  border rounded-lg">
            <div className="cards shadow-sm p-3">
              ...
              <h5 className="text-center mb-3" style={{ color: '#FFA200' }}>Patient</h5>
