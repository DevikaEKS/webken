...
export function Approve() {
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row">
      <div class="rounded-2 p-4 shadow border-0 mb-5 w-100">
        <div class="d-flex justify-content-between my-3">
          <h5 class="mb-0 pointer">Cheque Transaction</h5>
          {activeTable === 1 ? (
            <button
              class="mb-0 pointer btn btn-success my-2"
        ...
        <div class="table-responsive">
          <table class="w-100 table table-hover table-nowrap">
                ...
                {checktransation.map((value, index) => (
                  <tr>
                    <td id="id">
                      ...
                      <a class="text-heading font-bold text-decoration-none" href="#">
                        {value.id}
                      </a>
                    </td>
      ...
      <div class="p-4 shadow border-0 mb-7">
