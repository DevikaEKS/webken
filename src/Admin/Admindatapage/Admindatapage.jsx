  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4 mb-6 border-b pb-4 flex-wrap">
        {["Blog Leads", "Email Subscribers", "ContactLeads"].map((category) => (
          <button
            key={category}
        ...
        <button
          onClick={() => navigate("/bookarea")}
          className="px-4 py-2 text-[#001040] rounded hover:text-[#ffa200] cursor-pointer transition">
          Books
        </button>
        <button
          onClick={() => {
            ...
            <table className="min-w-full border border-gray-300">
              ...
              <tbody>
                {contactLeads.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="3" className="text-center py-4">No contact leads found.</td>
                  </tr>
                )}
              </tbody>
            </table>
